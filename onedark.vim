...
let s:sky_blue = { "gui": "#5fafd7", "cterm": "45", "cterm16": "14" }
...
call s:h("Include", { "fg": s:sky_blue }) " preprocessor #include
...
call s:h("IncSearch", { "fg": s:cyan, "bg": s:comment_grey }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
